...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col l6 push-l3 pull-l3 s12 center-align z-depth-4 hoverable"
            ...
            <form id="formUpdate" class="col s12" action="https://elegipcio.pe/script/updateProduct.php"
                  enctype="multipart/form-data" method="post">

                <div class="row">
                    <div class="col l12 s12 m12 xl12">
                        <a href="<?= $ir ?>" class="btn-flat btn-large waves-effect waves-light  black-text"
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input data-min-height="400" data-max-file-size="2M" data-min-width="400"
                               data-allowed-file-extensions="jpg" type="file" class="dropify" id="fotoSubir"
                               data-height="300"
                               data-default-file="https://elegipcio.pe/assets/img/promos/<?php echo $producto['imagenProducto'] ?>"
                ...
                <div class="row">
                    <div class="input-field col s12 l6 xl6 m6">
                        <select required class="validate" name="tipoProducto">
                            ...
                            <?php foreach ($listaTipoProductos as $tipoProducto) { ?>
                                <option class="left"
                                        data-icon="https://elegipcio.pe/assets/img/promos/<?php echo $tipoProducto['imageUrl'] ?>"
                    ...
                    <div class="input-field col s12 l6 xl12 m12">
                        <input value="<?php echo $producto['acumulaNPuntos']; ?>" name="puntosProducto"
                               onkeypress="return solonumeros()" required id="" type="number"
                               class="validate">
                ...
                <div class="row">
                    <div class="input-field col s12 l6 xl6 m6">
                        <select required class="validate" name="storeId">
                            ...
                            <option <?= ($producto['store_id']=='3')?'selected':'' ?> value="1">Tienda San Miguel</option>
                        </select>
                        <label>Tipo Producto</label>
                    </div>
                </div>
