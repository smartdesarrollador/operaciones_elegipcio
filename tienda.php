...
$tienda_db_san_miguel = $objTienda->getTiendaByIdSanMiguel(3);
...
-->
                ...
                <!--             <div class="z-depth-5" style="border-radius: 5px; border: 3px solid black;margin-top: 30px;">
                    ...
                    <form action="guardar_cantidad_total_san_miguel.php" method="POST" style="padding: 40px;">
                        ...
                        <input type="text" name="cantidad_total_san_miguel" placeholder="Ingresar cantidad" value="<?php echo $tienda_db_san_miguel["cantidadTotal"]; ?>">
