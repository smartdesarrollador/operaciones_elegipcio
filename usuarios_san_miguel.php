    ...
    <div class="container">
        <div class="row">
            <div class="col l4 s12 m4 xl4 push-l4 push-l4 push-xl4  push-m4 pull-m4 z-depth-5 hoverable " style="border-radius: 5px; border: 3px solid black;margin-top: 30px">
                <h5 class="center-align">Listado de Usuarios San Miguel</h5>
        ...
        <div class="row">
            ...
            <div id="test1" class="col s12  z-depth-5 hoverable " style="border-radius: 5px; border: 3px solid black;margin-top: 30px">
                <table id="puntos" class="display " style="width:100%">
                    ...
                    <tbody>
                        <?php foreach ($objTienda->getPuntosClientesSanMiguel() as $puntos) { ?>
                            <tr>
            ...
            <div id="test2" class="col s12  z-depth-5 hoverable " style="border-radius: 5px; border: 3px solid black;margin-top: 30px">
                <table id="ventas" class="display " style="width:100%">
                    ...
                    <tbody>
                        <?php foreach ($objTienda->getComprasxClienteSanMiguel() as $compras) { ?>
                            <tr>
