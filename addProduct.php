...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col l6 push-l3 pull-l3 s12 center-align z-depth-4 hoverable"
            ...
            <form class="col s12" action="https://elegipcio.pe/script/addProduct.php" enctype="multipart/form-data"
                  method="post">

                <div class="row">
                    <div class="input-field col s12">
                        <input data-min-height="410" data-max-file-size="2M" data-min-width="410" required
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12 l6 xl12 m12">
                        <input value="0" name="puntosProducto" min="0"
                               onkeypress="return solonumeros()" required type="number"
                               class="validate">
                ...
                <div class="row">
                    <div class="input-field col s12 l6 xl6 m6">
                        <select required class="validate" name="storeId">
                            ...
                            <option value="3">Tienda San Miguel</option>
                        </select>
                        <label>Tipo Producto</label>
                    </div>
                </div>
