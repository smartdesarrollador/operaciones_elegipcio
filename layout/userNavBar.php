        ...
        <div class="nav-wrapper black">
            <div class="">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="./" title="Ver los pedidos"
                           class="<?php echo ($page == "dashboard") ? 'orange-text' : 'white-text'; ?>"><i
                                    class="material-icons left">list_alt</i> Pedidos</a>
                    </li>
                    <li><a title="Cambiar Configuraciones de la tienda" href="tienda"
                           class="<?php echo ($page == "store") ? 'orange-text' : 'white-text'; ?>"><i
                                    class="material-icons left">store</i> Tienda</a></li>
                    <li>


                        <a href="javascript:;" data-target="dropdown3"
                           class="<?php echo ($page == "products") ? 'orange-text' : 'white-text'; ?> dropdown-trigger">

                            <i class="material-icons left">restaurant
                            </i> Productos <i class="material-icons right">arrow_drop_down</i></a>
                    </li>
                    <li><a href="usuarios"
                           class="<?php echo ($page == "usuarios") ? 'orange-text' : 'white-text'; ?>"><i
                                    class="material-icons left">supervisor_account
                            </i> Usuarios</a>
                    </li>

                    <li><a href="calidad"
                           class="<?php echo ($page == "calidad") ? 'orange-text' : 'white-text'; ?>"><i
                                    class="material-icons left">security
                            </i> Calidad</a>
                    </li>

                    <li><a href="reportes"
                           class="<?php echo ($page == "reportes") ? 'orange-text' : 'white-text'; ?>"><i
                                    class="material-icons left">insert_chart_outlined
                            </i> Reportes</a>
                    </li>
                    ...
                    <li><a class="dropdown-trigger capitalize" href="#!"
                           data-target="dropdown1">Hola, <?= $_SESSION["current_fullName"] ?>
...
<ul class="sidenav " id="mobile-demo">
    ...
    <li class="divider"></li>
    <li class="center-align"><p href="#" class="capitalize">
    ...
    <li class="center-align">
        ...
        <a href="productos"  data-target="dropdown2"
           class="<?php echo ($page == "products") ? 'orange-text' : ''; ?> dropdown-trigger"><i class="material-icons">restaurant
            </i>Productos</a>
...
<ul id="dropdown1" class="dropdown-content">
    ...
    <li><a onclick="return confirm('Estas Seguro?');"
           href="script/logOut.php">Cerrar Sesión <i class="material-icons">
                exit_to_app
            </i></a></li>
</ul>
