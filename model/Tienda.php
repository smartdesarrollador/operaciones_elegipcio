...
class Tienda
{
    ...
    public function updateCuponSanMiguel($cupon)
    {
    ...
    public function updateDescuentoSanMiguel($descuento)
    {
    ...
    public function updateCantidadTotalSanMiguel($cantidad_total)
    {
    ...
    public function getTiendaByIdSanMiguel()
    {
        try {
    ...
    public function updateFechaSanMiguel($fecha)
    {
